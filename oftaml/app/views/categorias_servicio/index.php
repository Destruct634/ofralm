<div class="container-fluid px-4">
    <h1 class="mt-4">Gestión de Categorías de Servicio</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.php?page=dashboard">Dashboard</a></li>
        <li class="breadcrumb-item active">Categorías de Servicio</li>
    </ol>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <table id="tablaCategoriasServicio" class="table table-striped table-bordered" style="width:100%">
...
<!-- Modal -->
<div class="modal fade" id="modalCategoriaServicio" tabindex="-1">
